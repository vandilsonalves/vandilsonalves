...
import {
  ...
  Zap, User, Upload, LogOut, Shield, Award, Home, CreditCard, UsersRound, Trophy, Handshake, Medal
} from 'lucide-react';
...
export default function MobileNav() {
  ...
  const menuItems = [
    ...
    { label: 'Parceiros', icon: Handshake, path: '/parceiros', color: 'text-blue-400' },
    { label: 'Votação', icon: Medal, path: '/votacao', color: 'text-amber-400' },
