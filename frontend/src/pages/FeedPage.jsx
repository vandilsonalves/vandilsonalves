...
import FeedAdminSidebar from '@/components/feed/FeedAdminSidebar';
    ...
    <div className="min-h-screen bg-slate-900 text-white" data-testid="feed-page">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {posts.length === 0 ? (
              ...
              posts.map((post) => (
                <FeedPostCard
                  ...
                  isAdmin={isAdmin}
                  token={token}
                  ReacoesDisplay={ReacoesDisplay}
                  ReacaoButton={ReacaoButton}
                  PostConteudoEspecial={PostConteudoEspecial}
                  BotaoParabens={BotaoParabens}
                  handleDeletarPost={handleDeletarPost}
                  handleDoubleTap={handleDoubleTap}
                  handleComentar={handleComentar}
                  handleFixarComentario={handleFixarComentario}
                  handleExcluirComentario={handleExcluirComentario}
                  handleBloquearUsuario={handleBloquearUsuario}
                  heartAnimation={heartAnimation}
                  showComentarios={showComentarios}
                  setShowComentarios={setShowComentarios}
          ...
          {/* Sidebar - Extraído */}
          <FeedAdminSidebar isAdmin={isAdmin} token={token} fetchFeed={fetchFeed} />
        </div>
      </div>
    </div>
  );
