...
import { generateShareCardImage } from '@/utils/canvasShareGenerator';
...
const RaioXPage = () => {
  ...
  // Canvas share card - extracted to /utils/canvasShareGenerator.js
  const generateShareCard = async () => {
    setGeneratingShare(true);
    try {
      const imageUrl = await generateShareCardImage({ data, badges, atleta });
  ...
  return (
    <div className="min-h-screen bg-slate-900" data-testid="raio-x-page">
      ...
      {showShareModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4" data-testid="share-modal-overlay">
          <div className="bg-slate-800 rounded-xl max-w-lg w-full max-h-[90vh] overflow-y-auto" data-testid="share-modal">
            {/* Header do Modal */}
