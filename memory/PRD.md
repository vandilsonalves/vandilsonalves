...
- **Ranking Run Inside - Busca por Link + Gráficos**: Campo de busca atualizado para aceitar links do Instagram (ex: `https://instagram.com/username`). Scraping real implementado com fallback para inserção manual. Corrigido crash de `Cannot read properties of undefined` ao visualizar análises existentes. Dashboard com 4 gráficos: Radar, Barras horizontais, Pizza/Donut, Comparativo vs Nicho.
